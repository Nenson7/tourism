...
// Correct bounds type for Leaflet
...
interface IlamLocation {
  ...
  bestTime: string
  highlights: string[]
  zoom?: number // <-- Add optional zoom property
}
          ...
          >
            ...
            >
              ...
              <ChangeView
                ...
                zoom={selectedLocation?.zoom ?? 13} // <-- Use default zoom if not set
          ...
          >
            {ILAM_LOCATIONS.map((loc, idx) => (
              <div
                ...
                className={`bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer border-2 ${selectedLocation?.name === loc.name
