      ...
      <div className="p-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-4">
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <span className="text-sm">{destination.details.distance}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-600">
            <FaCalendarAlt className="text-blue-500" />
            <span className="text-sm">{destination.details.bestSeason}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-600">
            <FaMountain className="text-purple-500" />
            <span className="text-sm">{destination.details.altitude}</span>
          </div>
          <div className="flex items-center gap-2 text-gray-600">
