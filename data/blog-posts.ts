...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "भालुढुङ्गा इलाम बजार नजिकैको चियाबारी र जंगलले घेरिएको रमणीय स्थल हो, जहाँ विशाल ढुङ्गा, गुफा, सुन्दर दृश्य र प्राकृतिक वातावरणले पर्यटकलाई आकर्षित गर्छ ।",
    author: "रामकुमार शाह",
    date: "२०६९ मंसिर ३",
    readTime: "5 min read",
    image: "/static/blog/blog-1.jpg",
